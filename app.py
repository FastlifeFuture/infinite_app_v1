...
if ENV =='dev':
    app.debug = True
    app.config['SQLALCHEMY_DATABASE_URI']= 'postgresql://postgres:Fastlife33@localhost/infinite_app_v1'
else:
    app.debug = False
    app.config['SQLALCHEMY_DATABASE_URI']= 'postgres://tgeuoiekbydwfb:adcf4f7d0ac5942af3848d9d4840bb9c9e09b8353f71294c8addbe5bd34742e1@ec2-100-26-39-41.compute-1.amazonaws.com:5432/ddgs0rbns1ea2g'
